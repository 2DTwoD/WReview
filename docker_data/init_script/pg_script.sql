...
insert into users values ('Лампочкин Анатолий Валерьевич', '$2a$14$jy68XNU/KC.vDw7wuqB8m.blNSiQgd2.gpmzPxKvjgyuDiUDL39Xm',
                          '1994-12-11', 89990123456, true, 'Электромонтер, лампочку поменяю на раз-два', '2010-06-05', 0, true, 'ROLE_USER');
insert into users values ('Генералов Сергей Николаевич', '$2a$14$jy68XNU/KC.vDw7wuqB8m.blNSiQgd2.gpmzPxKvjgyuDiUDL39Xm',
                          '1970-01-01', 89990000008, false, '', null, 0, true, 'ROLE_USER');


insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', 'Комната совещаний', 'Сгорела лампочка', 'Шабашкин Егор Игорьевич',
                            true, 'Лампу конечно поменял, но нагрубил в процессе', 3);
insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', 'Крыльцо склада', 'Замело снегом', 'Лопатин Антон Николаевич',
                            true, 'Очистил все как надо, хвалю', 10);
insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', 'Банкетный зал', 'Нужно приготовить суп для персонала', 'Тарелкина Анастасия Борисовна',
                            true, 'Суп вкусный, но много соли, за это минус 2 балла', 8);
insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', 'Уборная', 'Течет кран умывальника', 'Трудоголиков Иван Иванович',
                            false, 'Кран все еще течёт, слесарь сказал что надо заказать новый и ушел', 2);
insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', 'Склад готовой продукции', 'Отвалилось колесо у тележки', 'Лентяйкин Владимир Александрович',
                            true, 'Все сделал как надо, но теперь тележка поскрипывает', 7);
insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', 'Склад готовой продукции', 'Нужно перевезти стеллаж', 'Работина Юлия Сергеевна',
                            true, 'Стеллаж перевезла, но пришла с опозданием', 9);
insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', '', 'Нужно выточить деталь', 'Беспалый Юрий Дмитриевич',
                            true, 'Выточил, не подошло, пришлось напильником дорабатывать', 6);
insert into reviews values (nextval('reviews_id_seq'), '2023-12-01', 'Генералов Сергей Николаевич', 'Весы в лаборатории', 'Нужно бы откалибровать', 'Гирин Константин Денисович',
